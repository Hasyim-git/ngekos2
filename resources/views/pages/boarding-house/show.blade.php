...
@section('content')
    ...
    <div id="Content-Container"
        ...
        <div id="Gallery" class="swiper-gallery w-full overflow-hidden -mb-[38px]">
            <div class="swiper-wrapper">
                @foreach ($boardingHouse->rooms as $room)
                    @foreach ($room->images as $image)
                        <div class="swiper-slide w-full">
                            <div class="flex w-full h-[430px] overflow-hidden">
                                <img src="{{ asset('storage/' . $image->image) }}" class="w-full h-full object-cover" alt="gallery thumbnails">
                            </div>
                        </div>
                    @endforeach
                @endforeach
                    ...
                    <div class="flex flex-col gap-4">
                        ...
                        <div
                            ...
                            <div class="flex w-[120px] h-[90px] shrink-0 rounded-[18px] bg-[#D9D9D9] overflow-hidden">
                                <img src="{{ asset ('assets/images/thumbnails/bonus-1.png') }}" class="w-full h-full object-cover"
                                    alt="thumbnails">
                            </div>
                            <div>
